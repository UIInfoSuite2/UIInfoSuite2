...
internal static class ConfigPageNames
{
  ...
  public static string[] Items = [HudIcons, Tooltips, MenuFeatures, Keybinds, Advanced];
  ...
  public static GMCMPageTuple GetPageLinkStrings(string pageName)
  {
    return pageName switch
    {
      ...
      MenuFeatures => new GMCMPageTuple(
        I18n.Gmcm_Page_MenuFeatures_Title,
        I18n.Gmcm_Page_MenuFeatures_Tooltip
      ),
...
internal static class ConfigSectionNames
{
  ...
  public static GMCMPageTuple GetSectionTitleStrings(string sectionName)
  {
    ...
    {
      HudGlobal => new GMCMPageTuple(
        I18n.Gmcm_Section_HudGlobal_Title,
        I18n.Gmcm_Section_HudGlobal_Tooltip
      ),
      StatusIcons => new GMCMPageTuple(
        I18n.Gmcm_Section_StatusIcons_Title,
        I18n.Gmcm_Section_StatusIcons_Tooltip
      ),
