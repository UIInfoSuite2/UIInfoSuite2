...
public interface ICloudySkiesApi
{
  ...
  ///   The <see cref="IAssetData" /> you get
  ///   in your asset requested event handler.
  /// </param>
  ...
  /// <returns>
  ///   Whether or not the layer was registered successfully. If this returns false, that type name was already in
  ///   use.
  /// </returns>
  ...
  /// <returns>
  ///   Whether or not the effect was registered successfully. If this returns false, that type name was already in
  ///   use.
  /// </returns>
...
///   code runs locally, so you should use
///   <see cref="StardewValley.Game1.player">
...
public interface IScreenTintData
{
  ...
  ///   you should use multiple lighting entries with different
  ///   <see cref="TimeOfDay">
...
public interface IModifyHealthEffectData : IEffectData
{
  ...
  ///   this is a rough value, as the
  ///   <see cref="StardewValley.Farmer.takeDamage(int, bool, StardewValley.Monsters.Monster)" />
