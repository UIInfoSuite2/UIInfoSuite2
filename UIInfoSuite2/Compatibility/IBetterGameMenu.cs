...
public interface IPageOverlayCreationEvent
{
  ...
  /// </summary>
  /// <param name="overlay">
  ///   The overlay to add. Note that this isn't an <see cref="IPageOverlay" />
  ///   since we do special proxying for performance. All methods are optional.
  /// </param>
...
public interface IBetterGameMenu
{
  ...
  /// <param name="source">
  ///   The unique ID of the mod that registered the
  ...
  ///   If set to true, an instance will attempt to
  ...
  /// </summary>
  /// <param name="target">
  ///   Optionally, a specific tab to update rather than
  ///   updating all tabs.
  /// </param>
...
public interface IBetterGameMenuApi
{
  ...
  /// <param name="order">
  ///   The order of this tab relative to other tabs.
  ///   See <see cref="VanillaTabOrders" /> for an example of existing values.
  /// </param>
  /// <param name="getDisplayName">
  ///   A method that returns the display name of
  ///   this tab, to be displayed in a tool-tip to the user.
  /// </param>
  /// <param name="getIcon">
  ///   A method that returns an icon to be displayed
  ///   on the tab UI for this tab, expecting both a texture and a Rectangle.
  /// </param>
  /// <param name="priority">
  ///   The priority of the default page instance
  ...
  ///   mod can only register one provider for any given tab.
  /// </param>
  /// <param name="getPageInstance">
  ///   A method that returns a page instance
  ///   for the tab. This should never return a <c>null</c> value.
  /// </param>
  /// <param name="getDecoration">
  ///   A method that returns a decoration for
  ...
  ///   to the tab.
  /// </param>
  /// <param name="getTabVisible">
  ///   A method that returns whether or not the
  ...
  ///   is called.
  /// </param>
  /// <param name="getMenuInvisible">
  ///   A method that returns the value that the
  ///   game menu should set its <see cref="IBetterGameMenu.Invisible" /> flag
  ///   to when this is the active tab.
  /// </param>
  /// <param name="getWidth">
  ///   A method that returns a specific width to use when
  ///   rendering this tab, in case the page instance requires a different width
  ///   than the standard value.
  /// </param>
  /// <param name="getHeight">
  ///   A method that returns a specific height to use
  ///   when rendering this tab, in case the page instance requires a different
  ///   height than the standard value.
  /// </param>
  /// <param name="onResize">
  ///   A method that is called when the game window is
  ...
  /// </param>
  /// <param name="onClose">
  ///   A method that is called whenever a page instance
  ...
  ///   it for menus that were replaced by the <c>onResize</c> method.
  /// </param>
  void RegisterTab(
    string id,
    int order,
  ...
  /// </summary>
  /// <param name="id">
  ///   The id of the tab to register an implementation for.
  ///   The keys for the vanilla game tabs are the same as those in the
  ///   <see cref="VanillaTabOrders" /> enum.
  /// </param>
  /// <param name="priority">
  ///   The priority of this page instance provider
  ...
  /// <param name="closeExistingMenu">
  ///   If true, attempt to close the <see cref="Game1.activeClickableMenu" />
  ...
  ///   The tab that the menu should be opened to.
  ...
  delegate void PageOverlayCreationDelegate(IPageOverlayCreationEvent evt);

  delegate void PageReadyToCloseDelegate(IPageReadyToCloseEvent evt);
