...
internal static class ShopMenu_Patches
{
  public static void Patch(Harmony harmony)
  {
     ...
     * will always try and call TooltipExtensionManager#UpdateHoverItem with a null value (since that's what ShopMenu passes).
     *
     * As a sort of band-aid fix, we patch into performHoverAction and set TooltipExtensionManager.ShopMenuHoverItem
     * if the item is one in our inventory. ShopMenu#draw -> IClickableMenu#drawHoverText will try and call
     * TooltipExtensionManager#UpdateHoverItem with null after we've done this (since the call passed no item),
      ...
      .Insert(
        ...
        new CodeInstruction(
          ...
          AccessTools.DeclaredPropertySetter(
            ...
            nameof(TooltipExtensionManager.ShopMenuHoverItem)
          )
        )
      );
  ...
  private static void Postfix_ShopMenu_performHoverAction(ShopMenu __instance)
  {
    ...
    {
      TooltipExtensionManager.ShopMenuHoverItem = null;
    }
  }
}
