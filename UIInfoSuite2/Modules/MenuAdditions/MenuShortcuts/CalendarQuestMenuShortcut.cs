...
internal class CalendarQuestMenuShortcut : MenuShortcutElement
{
  ...
  public CalendarQuestMenuShortcut(int finalHeight)
    : base(finalHeight) { }
  ...
  protected override Rectangle SourceRectangle =>
    new(122, 291, (int)InitialWidth, (int)InitialHeight);

  protected override string GetHoverText()
  {
    return Game1.getMouseX() < MenuButton.bounds.X + MenuButton.bounds.Width / 2
      ? I18n.Calendar()
      : I18n.Billboard();
  }
